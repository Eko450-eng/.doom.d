...
(custom-theme-set-faces
 'eko
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#0a0f14" :foreground "#98d1ce" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 99 :width normal :foundry "ADBO" :family "Source Code Pro"))))
