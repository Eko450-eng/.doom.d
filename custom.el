(custom-set-variables
 ...
 '(package-selected-packages
   '(typescript-mode centered-window lsp-python-ms gotham-theme shell-pop ipretty prettier-js vterm hide-mode-line prettier htmltagwrap company tide rjsx-mode evil treemacs))
