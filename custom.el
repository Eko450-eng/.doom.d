...
(global-set-key (kbd "C-x C-u") 'lsp-java-add-import)

(setq auto-mode-alist (delete '("\\.ts\\'" . typescript-tsx-mode) auto-mode-alist))
(add-to-list 'auto-mode-alist '("\\.ts\\'" . rjsx-mode))
(add-to-list 'auto-mode-alist '("\\.java\\'" . java-mode))

(defun forgeRunClient()
  (interactive)
  (let ((default-directory "/home/eko/code/minecraft/forge-1.16.5-36.2.19-mdk"))(shell-command "./gradlew runClient")))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(md-readme vterm tide skewer-mode shell-pop rjsx-mode prettier-js prettier org-preview-html multiple-cursors lsp-python-ms lsp-javacomp lsp-java lsp-intellij lorem-ipsum jtags javap-mode javaimp javadoc-lookup ipretty intellij-theme htmltagwrap hide-mode-line gotham-theme evil company))
